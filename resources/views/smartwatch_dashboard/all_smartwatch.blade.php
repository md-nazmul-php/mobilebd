...
@section('title','Product - Smartwatch')

@section('content')
<div class="mb-2 pb-1 border-bottom">
	<a class="px-3 py-1 bg-secondary text-white" href="{{route('smartwatch.all')}}">Products</a>
...
<div class="mt-3">
	<a class="bg-success text-white py-1 px-2" href="{{route('smartwatch.add')}}">Post New Product</a>
</div>
<div class="mt-1 px-2">
