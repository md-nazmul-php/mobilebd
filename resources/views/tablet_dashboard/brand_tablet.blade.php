...
<div class="row">
	<div class="col-md-4 border-right">
		<div class="text-center">
			<h2 class="text-success">Add new Tablet Brand</h2>
		</div>
		...
		<div class="mt-5 mb-3 px-2">
			<form method="POST" action="{{route('tablet_brand.save')}}" enctype="multipart/form-data">
				@csrf
	...
	<div class="col-md-8">
		<div class="text-center text-primary">
			<h2 class="pb-2">Tablet Brands (Total : {{$brands->count()}})</h2>
		</div>
					...
					<tr>
						...
						<td class="p-0 m-0">
							...
							<div class="d-flex p-0" style="font-size: 10px;position:absolute; bottom: 0; left: 0;">
								...
								<form action="{{ route('edit_tablet_brand.page', ['brandID' => $brand->id]) }}" method="post">
									@csrf
								...
								<form action="{{ route('delete_brand.tablet', ['brandID' => $brand->id]) }}" method="post">
									@csrf
