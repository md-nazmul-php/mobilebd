...
<div class="row">
	<div class="col-md-4 border-right">
		<div class="text-center">
			<h2 class="text-success">Add new Laptop Category</h2>
		</div>
		...
		<div class="mt-4 mb-3 px-2">
			<form method="POST" action="{{route('laptop_category.save')}}">
				@csrf
	...
	<div class="col-md-8">
		<div class="text-center text-primary">
			<h2>Laptop Categories (Total: {{$categoris->count()}})</h2>
		</div>
					...
					<tr>
						...
						<td class="p-0 m-0">
							...
							<div class="d-flex p-0" style="font-size: 10px;position:absolute; bottom: 0; left: 0;">
								...
								<form action="{{ route('edit_laptop_category.page', ['categoryID' => $category->id]) }}" method="post">
									@csrf
								...
								<form action="{{ route('delete_category.laptop', ['categoryID' => $category->id]) }}" method="post">
									@csrf
